...
return array(
	...
	'content'       => '
	<!-- wp:group {"align":"full","className":"fr-animate fr-flip","layout":{"inherit":true}} -->
<div class="wp-block-group alignfull fr-animate fr-flip"><!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"top":"20px","right":"40px","bottom":"20px","left":"50px"}},"border":{"radius":"8px"}},"gradient":"diagonal-primary-to-secondary","className":"fr-negative-margin-5 is-style-middleshadow"} -->
<div class="wp-block-group alignwide fr-negative-margin-5 is-style-middleshadow has-diagonal-primary-to-secondary-gradient-background has-background" style="border-radius:8px;padding-top:20px;padding-right:40px;padding-bottom:20px;padding-left:50px"><!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}}} -->

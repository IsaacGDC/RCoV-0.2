...
<div class="wp-block-column is-vertically-aligned-bottom"><!-- wp:group {"style":{"spacing":{"blockGap":"25%"}},"layout":{"type":"flex","allowOrientation":false,"justifyContent":"center"}} -->
<div class="wp-block-group"><!-- wp:image {"id":6569,"width":64,"height":64,"sizeSlug":"full","linkDestination":"none","className":"fr-animate fr-move-up fr-delay-3 fr-negative-margin-bottom-5", "style":{"color":{"duotone":["#c1e5d8","#2184f9"]}}} -->
<figure class="wp-block-image size-full is-resized fr-animate fr-move-up fr-delay-3 fr-negative-margin-bottom-5"><img src="'.BLOCKPRESS_THEME_DIR.'/assets/patterns/qa-1.svg" width="64" height="64" alt="" class="wp-image-6569"/></figure>
<!-- /wp:image -->

<!-- wp:image {"id":6570,"sizeSlug":"full","width":64,"height":64,"linkDestination":"none","className":"fr-negative-margin-3 fr-animate fr-move-up fr-delay-5", "style":{"color":{"duotone":["#fed54b","#2184f9"]}}} -->
<figure class="wp-block-image size-full fr-negative-margin-3 is-resized fr-animate fr-move-up fr-delay-5"><img src="'.BLOCKPRESS_THEME_DIR.'/assets/patterns/qa-2.svg" width="64" height="64" alt="" class="wp-image-6570"/></figure>
<!-- /wp:image -->

<!-- wp:image {"id":6572,"sizeSlug":"full","width":64,"height":64,"linkDestination":"none","className":"fr-negative-margin-bottom-10 fr-animate fr-move-up fr-delay-10", "style":{"color":{"duotone":["#fe835d","#2184f9"]}}} -->
<figure class="wp-block-image size-full is-resized fr-negative-margin-bottom-10 fr-animate fr-move-up fr-delay-10"><img src="'.BLOCKPRESS_THEME_DIR.'/assets/patterns/qa-3.svg" width="64" height="64" alt="" class="wp-image-6572"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<video autoplay loop muted poster="'.BLOCKPRESS_THEME_DIR.'/assets/patterns/qa.webp" preload="auto" src="'.BLOCKPRESS_THEME_DIR.'/assets/patterns/qavideo.webm" playsinline>
</video>
</figure>
<!-- /wp:video -->

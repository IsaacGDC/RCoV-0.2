...
<div class="wp-block-group alignfull is-style-no-margin has-background" style="background-color:#f5f4fe;padding-bottom:80px"><!-- wp:spacer {"height":30} -->
...
<p class="has-text-align-center fr-animate fr-flip fr-delay-3 has-max-huge-font-size" style="font-style:normal;font-weight:700;line-height:1.2">Find our our special unique features</p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"padding":{"right":"70px","left":"70px"}}},"frMobPaddingDisable":true} -->
<div class="wp-block-group fr-mobile-paddingdisable" style="padding-right:70px;padding-left:70px"><!-- wp:paragraph {"align":"center","className":"fr-animate fr-move-up fr-delay-5"} -->
<p class="has-text-align-center fr-animate fr-move-up fr-delay-5">We\'ve gone over everything you could possibly want to have. You are one step closer to success</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-column fr-animate fr-move-up"><!-- wp:group {"style":{"spacing":{"padding":{"top":"30px","right":"30px","bottom":"30px","left":"30px"},"blockGap":"45px"},"border":{"width":"1px","style":"solid"}, "color":{"background":"#ffffff"}},"borderColor":"lightborder","className":"is-style-hovershadow"} -->
<div class="wp-block-group is-style-hovershadow has-border-color has-lightborder-border-color has-background" style="background-color:#ffffff;border-style:solid;border-width:1px;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px"><!-- wp:image {"id":6492,"width":60,"height":60,"sizeSlug":"full","linkDestination":"none","className":"is-style-default", "style":{"color":{"duotone":["#7000f4","#2184f9"]}} } -->
...
<div class="wp-block-column fr-animate fr-move-up fr-delay-3"><!-- wp:group {"style":{"spacing":{"padding":{"top":"30px","right":"30px","bottom":"30px","left":"30px"},"blockGap":"45px"},"border":{"width":"1px","style":"solid"}, "color":{"background":"#ffffff"}},"borderColor":"lightborder","className":"is-style-hovershadow"} -->
<div class="wp-block-group is-style-hovershadow has-border-color has-lightborder-border-color has-background" style="background-color:#ffffff;border-style:solid;border-width:1px;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px"><!-- wp:image {"id":6680,"width":60,"height":60,"sizeSlug":"full","linkDestination":"none","className":"is-style-default", "style":{"color":{"duotone":["#7000f4","#2184f9"]}} } -->
...
<div class="wp-block-column fr-animate fr-move-up fr-delay-5"><!-- wp:group {"style":{"spacing":{"padding":{"top":"30px","right":"30px","bottom":"30px","left":"30px"},"blockGap":"45px"},"border":{"width":"1px","style":"solid"}, "color":{"background":"#ffffff"}},"borderColor":"lightborder","className":"is-style-hovershadow"} -->
<div class="wp-block-group is-style-hovershadow has-border-color has-lightborder-border-color has-background" style="background-color:#ffffff;border-style:solid;border-width:1px;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px"><!-- wp:image {"id":6496,"width":60,"height":60,"sizeSlug":"full","linkDestination":"none","className":"is-style-default", "style":{"color":{"duotone":["#7000f4","#2184f9"]}}} -->
...
<div class="wp-block-column  fr-animate fr-move-up fr-delay-7"><!-- wp:group {"style":{"spacing":{"padding":{"top":"30px","right":"30px","bottom":"30px","left":"30px"},"blockGap":"45px"},"border":{"width":"1px","style":"solid"}, "color":{"background":"#ffffff"}},"borderColor":"lightborder","className":"is-style-hovershadow"} -->
<div class="wp-block-group is-style-hovershadow has-border-color has-lightborder-border-color has-background" style="background-color:#ffffff;border-style:solid;border-width:1px;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px"><!-- wp:image {"id":6497,"width":60,"height":60,"sizeSlug":"full","linkDestination":"none","className":"is-style-default", "style":{"color":{"duotone":["#7000f4","#2184f9"]}}} -->
...
<p class="has-text-align-center">Didn\'t find what you need?</p>
<!-- /wp:paragraph -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"align":"center","style":{"border":{"radius":"3px"}},"className":"is-style-outline-black"} -->
<div class="wp-block-button aligncenter is-style-outline-black"><a class="wp-block-button__link" style="border-radius:3px">Browse all categories</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->

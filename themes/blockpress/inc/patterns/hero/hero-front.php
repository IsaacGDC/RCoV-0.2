...
return array(
	...
	'content'       => '<!-- wp:group {"align":"full","style":{"color":{"gradient":"linear-gradient(177deg,rgb(255,255,255) 0%,rgb(249,250,251) 100%)"},"spacing":{"padding":{"bottom":"60px","top":"0px"}}},"layout":{"inherit":true}} -->
    <div class="wp-block-group alignfull has-background" style="background:linear-gradient(177deg,rgb(255,255,255) 0%,rgb(249,250,251) 100%);padding-top:0px;padding-bottom:60px"><!-- wp:columns {"align":"wide"} -->
    <div class="wp-block-columns alignwide"><!-- wp:column {"verticalAlignment":"center","width":"50%"} -->
    <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:heading {"level":6,"style":{"typography":{"fontStyle":"normal","fontWeight":"400","textTransform":"uppercase"}},"className":"is-style-line-separator fr-animate fr-move-up","fontSize":"xsmall"} -->
    <h6 class="is-style-line-separator fr-animate fr-move-up has-xsmall-font-size" id="extremelly-fast" style="font-style:normal;font-weight:400;text-transform:uppercase">Extremelly fasT</h6>
    <!-- /wp:heading -->
